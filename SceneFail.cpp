...
void SceneFail::draw()
{
	...
	DrawFormatString(Game::kScreenWidth / 2 - 150, Game::kScreenHeight / 2 + 120, GetColor(0, 0, 0), "やつ「恐怖の帝王はこのオレだッッ！\n　　　以前変わりなくッ！」");
	//SetFontSize(30);
	DrawString(Game::kScreenWidth / 2 - 80, Game::kScreenHeight / 2 - 100, "ＧＡＭＥＯＶＥＲ", GetColor(255, 0, 0));
